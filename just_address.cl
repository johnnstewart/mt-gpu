...
__kernel void just_address(
    ...
    // Write the generated address to the output buffer
    int address_size = 25; // Size of raw Bitcoin address in bytes
    for(int i = 0; i < address_size; i++) {
        output_addresses[idx * address_size + i] = raw_address[i];
    }
}
