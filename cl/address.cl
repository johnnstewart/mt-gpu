...
void sha256d(uchar *input, int input_len, char * output) {
  sha256((__private const uchar *)input, input_len, (__private uchar *)output);;
  sha256((__private const uchar *)output, 32, (__private uchar *)output);;
}

void hash160(uchar *input, int input_len, char * output) {
  uchar sha256_result[32] = { 0 };
  sha256((__private const uchar *)input, input_len, (__private uchar *)&sha256_result);
  ripemd160((__private const uchar *)&sha256_result, 32, (__private uchar *)output);
